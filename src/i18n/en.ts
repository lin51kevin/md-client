...
export const en: Record<TranslationKey, string> = {
  ...
  'settings.appearance.previewTheme': 'Preview Theme',
  'settings.appearance.previewThemeDesc': 'Choose display style for Markdown preview area',
  'settings.appearance.previewThemeDefault': 'Default',
  'settings.appearance.previewThemeDark': 'Dark',
  'settings.appearance.previewThemeSepia': 'Eye Care (Green)',
  'settings.appearance.previewThemeHighContrast': 'High Contrast',
