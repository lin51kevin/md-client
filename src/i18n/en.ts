...
export const en: Record<TranslationKey, string> = {
  ...
  'settings.appearance.customThemesDesc': 'Import custom color schemes from JSON files',
  'settings.appearance.importTheme': 'Import JSON Theme',
  'settings.appearance.importThemeError': 'Import failed',
  'settings.appearance.noCustomThemes': 'No custom themes installed',
  'settings.appearance.removeTheme': 'Remove',
  'settings.appearance.themeFormatHint': 'View JSON theme format example',
  'settings.appearance.customCss': 'Custom CSS',
  'settings.appearance.customCssDesc': 'Inject custom styles into the preview and editor (live preview)',
  'settings.appearance.cssTemplates': 'CSS Templates',
  'settings.appearance.cssTemplatesDesc': 'Save and manage custom CSS templates for quick switching',
  'settings.appearance.saveTemplate': 'Save Current as Template',
  'settings.appearance.importTemplate': 'Import Template',
  'settings.appearance.exportTemplate': 'Export',
  'settings.appearance.removeTemplate': 'Remove',
  'settings.appearance.applyTemplate': 'Apply',
  'settings.appearance.noTemplates': 'No templates saved',
  'settings.appearance.templateName': 'Template Name',
  'settings.appearance.saveAsTemplate': 'Save Current as Template',
  'settings.appearance.deleteTemplate': 'Delete',
  'settings.appearance.templateSaveSuccess': 'Template saved',
  'settings.appearance.templateImportError': 'Failed to import template',
  ...
  'aiCopilot.scope.selection': 'SEL',
  'aiCopilot.scope.document': 'DOC',
  'aiCopilot.scope.tab': 'TAB',
  'aiCopilot.scope.workspace': 'WS',
  'aiCopilot.scope.tooltip': 'Edit scope: {scope}',
