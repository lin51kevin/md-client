...
export const en: Record<TranslationKey, string> = {
  ...
  'settings.shortcuts.replaceInFile': 'Replace',
  'settings.shortcuts.globalSearch': 'Search in Files',
  'settings.shortcuts.globalReplace': 'Replace in Files',
  ...
  'settings.shortcuts.formatDocument': 'Format Document',
  ...
  'toolbar.listLift': 'Remove List',
  'toolbar.headingPromote': 'Promote Heading',
  'toolbar.headingDemote': 'Demote Heading',
  'toolbar.renumberOl': 'Renumber List',
  'toolbar.formatDocument': 'Format Document (Shift+Alt+F)',
  'toolbar.paragraphGroup': 'Paragraph',
  'toolbar.insertGroup': 'Insert',
  'toolbar.moreGroup': 'More',
  'toolbar.spellCheck': 'Spell Check',
  'toolbar.vimMode': 'Vim Mode',
  'format.unsupported': 'Formatting is not supported for this file type',
  'format.success': 'Document formatted',
  'format.noChange': 'Document is already formatted',
  'format.error': 'Formatting failed: the content has syntax errors',
  ...
  'toolbar.editablePreview': 'Editable Preview (WYSIWYG)',
  ...
  'search.regex': 'Regex',
  'search.enterHint': 'Type a keyword to search',
