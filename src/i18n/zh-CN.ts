export const zhCN = {
  ...
  'settings.preview.milkdownPreview': '预览窗口可编辑',
  'settings.preview.milkdownPreviewDesc': '在预览区启用 Milkdown 富文本编辑器（关闭后仅显示只读预览）',
  'settings.preview.mermaidTheme': 'Mermaid 主题',
  'settings.preview.mermaidThemeDesc': 'Mermaid 图表的渲染主题',
  'settings.preview.mermaidDefault': '默认',
  'settings.preview.mermaidForest': '森林',
  'settings.preview.mermaidDark': '暗色',
  'settings.preview.mermaidNeutral': '中性',
  ...
  'settings.shortcuts.replaceInFile': '替换',
  'settings.shortcuts.globalSearch': '跨文件搜索',
  'settings.shortcuts.globalReplace': '跨文件替换',
  ...
  'settings.shortcuts.closeAllTabs': '关闭所有标签页',
  'settings.shortcuts.formatBold': '加粗',
  'settings.shortcuts.formatItalic': '斜体',
  'settings.shortcuts.formatStrikethrough': '删除线',
  'settings.shortcuts.formatCode': '行内代码',
  'settings.shortcuts.formatLink': '插入链接',
  'settings.shortcuts.formatImage': '插入图片',
  'settings.shortcuts.formatHeading': '标题',
  'settings.shortcuts.formatOrderedList': '有序列表',
  'settings.shortcuts.formatUnorderedList': '无序列表',
  'settings.shortcuts.formatBlockquote': '引用',
  'settings.shortcuts.formatTable': '插入表格',
  'settings.shortcuts.formatHorizontalRule': '分割线',
  'settings.shortcuts.formatDocument': '格式化文档',
  'settings.shortcuts.mindmapMode': '思维导图',
  'settings.shortcuts.fullscreen': '全屏',
  'settings.shortcuts.toggleSearchPanel': '切换搜索面板',
  'settings.shortcuts.togglePluginsPanel': '切换插件面板',
  'settings.shortcuts.toggleCommandPalette': '命令面板',
  'settings.shortcuts.toggleQuickOpen': '快速打开',
  'settings.shortcuts.revealActiveFile': '在资源管理器中显示',
  'settings.shortcuts.category.file': '文件',
  'settings.shortcuts.category.edit': '编辑',
  'settings.shortcuts.category.view': '视图',
  'settings.shortcuts.category.format': '格式',
  'settings.shortcuts.category.panel': '面板',
  ...
  'toolbar.ul': '无序列表',
  'toolbar.ol': '有序列表',
  'toolbar.listLift': '移除列表',
  'toolbar.headingPromote': '升级标题',
  'toolbar.headingDemote': '降级标题',
  'toolbar.renumberOl': '重新编号',
  'toolbar.formatDocument': '格式化文档 (Shift+Alt+F)',
  'toolbar.paragraphGroup': '段落格式',
  'toolbar.insertGroup': '插入内容',
  'toolbar.moreGroup': '更多',
  'toolbar.spellCheck': '拼写检查',
  'toolbar.vimMode': 'Vim 模式',
  'format.unsupported': '当前文件类型暂不支持格式化',
  'format.success': '文档已格式化',
  'format.noChange': '文档已符合格式规范',
  'format.error': '格式化失败：内容存在语法错误',
  'toolbar.link': '插入链接',
  ...
  'preview.ctx.copy': '复制',
  'preview.ctx.copyAsMarkdown': '复制为 Markdown',
  'preview.ctx.viewSource': '查看源码',
  'ctx.aiPolish': '✨ AI 润色',
  'ctx.aiExplain': '📖 AI 解释',
