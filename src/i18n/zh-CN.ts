export const zhCN = {
  ...
  'settings.appearance.previewTheme': '预览主题',
  'settings.appearance.previewThemeDesc': '选择 Markdown 预览区域的显示样式',
  'settings.appearance.previewThemeDefault': '默认',
  'settings.appearance.previewThemeDark': '暗黑',
  'settings.appearance.previewThemeSepia': '护眼（浅绿）',
  'settings.appearance.previewThemeHighContrast': '高对比',
