export const zhCN = {
  ...
  'settings.appearance.customThemesDesc': '从 JSON 文件导入自定义主题色方案',
  'settings.appearance.importTheme': '导入 JSON 主题',
  'settings.appearance.importThemeError': '导入失败',
  'settings.appearance.noCustomThemes': '暂无自定义主题',
  'settings.appearance.removeTheme': '移除',
  'settings.appearance.themeFormatHint': '查看 JSON 主题格式示例',
  'settings.appearance.customCss': '自定义 CSS',
  'settings.appearance.customCssDesc': '为预览区和编辑器注入自定义样式（实时生效）',
  'settings.appearance.cssTemplates': 'CSS 模板',
  'settings.appearance.cssTemplatesDesc': '保存和管理自定义 CSS 模板，快速切换不同风格',
  'settings.appearance.saveTemplate': '保存当前为模板',
  'settings.appearance.importTemplate': '导入模板',
  'settings.appearance.exportTemplate': '导出',
  'settings.appearance.removeTemplate': '删除',
  'settings.appearance.applyTemplate': '应用',
  'settings.appearance.noTemplates': '暂无保存的模板',
  'settings.appearance.templateName': '模板名称',
  'settings.appearance.saveAsTemplate': '保存当前为模板',
  'settings.appearance.deleteTemplate': '删除',
  'settings.appearance.templateSaveSuccess': '模板已保存',
  'settings.appearance.templateImportError': '导入模板失败',
  ...
  'aiCopilot.scope.selection': '选区',
  'aiCopilot.scope.document': '文档',
  'aiCopilot.scope.tab': '标签',
  'aiCopilot.scope.workspace': '工作区',
  'aiCopilot.scope.tooltip': '编辑范围: {scope}',
