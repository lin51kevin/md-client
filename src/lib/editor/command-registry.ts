...
export function createCommandRegistry(deps: CommandRegistryDeps): Command[] {
  ...
  const builtInCommands: Command[] = [
    ...
    { id: 'view.slide', label: '幻灯片', labelEn: 'Slide Show', shortcut: 'Ctrl+4', category: 'view', action: () => setViewMode('slide') },
    { id: 'view.mindmap', label: '思维导图', labelEn: 'Mindmap', shortcut: 'Ctrl+5', category: 'view', action: () => setViewMode('mindmap') },
